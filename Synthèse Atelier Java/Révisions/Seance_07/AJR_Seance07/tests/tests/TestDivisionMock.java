...
public class TestDivisionMock {
  ...
  private void amenerALEtat(int etat, Division division) {
    for (int i = 1; i <= etat; i++) {
      this.division.ajouterEquipe(new EquipeMock(i, this.division, this.club, false, true,
          this.division, false, false, false));
    }
  }
  ...
  public void TestDivisionTC1() {
    EquipeMock equipe =
        new EquipeMock(1, null, this.club, false, true, this.division, false, false, false);
  ...
  public void TestDivisionTC2() {
    ...
    EquipeMock equipe =
        new EquipeMock(2, null, this.club, false, true, this.division, false, false, false);
    assertTrue(this.division.ajouterEquipe(equipe));
    assertTrue(this.division.contientEquipe(equipe));
  ...
  public void TestDivisionTC3() {
    ...
    EquipeMock equipe =
        new EquipeMock(13, null, this.club, false, false, this.division, false, false, false);
  ...
  public void TestDivisionTC4() {
    ...
    EquipeMock equipe = new EquipeMock(2, autreDivision, this.club, true, false, this.division,
        false, false, false);
    assertFalse(this.division.ajouterEquipe(equipe));
    assertFalse(this.division.contientEquipe(equipe));
  ...
  public void TestDivisionTC5() {
    EquipeMock equipe = new EquipeMock(1, this.division, this.club, false, true, this.division,
        false, false, false);
    assertTrue(this.division.ajouterEquipe(equipe));
    assertTrue(this.division.contientEquipe(equipe));
    assertEquals(this.division.nombreDEquipes(), 1);
