...
public class TestDivisionStub {
  ...
  private void amenerALEtat(int etat, Division division) {
    for (int i = 1; i <= etat; i++) {
      this.division.ajouterEquipe(new EquipeStub(i, this.division, this.club, false, false, false));
    }
  }

  @Test
  public void TestDivisionTC1() {
    Equipe equipe = new EquipeStub(1, null, this.club, false, false, false);
  ...
  public void TestDivisionTC2() {
    ...
    Equipe equipe = new EquipeStub(2, null, this.club, false, false, false);
    assertTrue(this.division.ajouterEquipe(equipe));
    assertTrue(this.division.contientEquipe(equipe));
  ...
  public void TestDivisionTC4() {
    ...
    Equipe equipe = new EquipeStub(12, null, this.club, false, false, false);
    assertTrue(this.division.ajouterEquipe(equipe));
    assertTrue(this.division.contientEquipe(equipe));
  ...
  public void TestDivisionTC5() {
    ...
    Equipe equipe = new EquipeStub(13, null, this.club, false, false, false);
    assertFalse(this.division.ajouterEquipe(equipe));
  ...
  public void TestDivisionTC6() {
    ...
    Equipe equipe = new EquipeStub(1, autreDivision, this.club, false, true, false);
    assertFalse(this.division.ajouterEquipe(equipe));
    assertFalse(this.division.contientEquipe(equipe));
  ...
  public void TestDivisionTC7() {
    Equipe equipe = new EquipeStub(1, this.division, this.club, false, true, false);
    assertTrue(this.division.ajouterEquipe(equipe));
    assertTrue(this.division.contientEquipe(equipe));
    assertEquals(this.division.nombreDEquipes(), 1);
  }
  ...
  public void TestDivisionTC15() {
    try {
      assertTrue(this.division.ajouterEquipe(null));
  ...
  public void TestDivisionTC16() {
    amenerALEtat(1, this.division);
    try {
      assertTrue(this.division.supprimerEquipe(null));
  ...
  public void TestDivisionTC17() {
    amenerALEtat(1, this.division);
    try {
      assertTrue(this.division.contientEquipe(null));
      fail(" Contient -> Il fallait lancer une IllegalArgumentException");
    } catch (IllegalArgumentException ignore) {
      assertEquals(this.division.nombreDEquipes(), 1);
    }
  }
  ...
  public void TestDivisionTC21() throws MinimumMultiplicityException {
    ...
    for (int i = 1; i <= 12; i++) {
      Equipe e = new EquipeStub(i, this.division, this.club, false, false, false);
