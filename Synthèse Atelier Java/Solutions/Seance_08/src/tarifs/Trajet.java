...
public class Trajet implements Comparable<Trajet>,Serializable {
	...
	private static final long serialVersionUID = -9139782075188873616L;
	...
	public int compareTo(Trajet o) {
		...
		if (res != 0)
			return res;
		return this.gareArrivee.compareTo(gareArrivee);
	}
	...
	public String toString() {
		return "De " + gareDepart + " ра " + gareArrivee + " : " + distance
				+ " km";
	}
