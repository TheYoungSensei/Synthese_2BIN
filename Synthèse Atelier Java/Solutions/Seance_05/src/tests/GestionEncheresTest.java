...
public class GestionEncheresTest {
	...
	@Test
	public void testMettreEnVente3()  {
	...
	public void testEncherir1() throws ObjetInexistantException, UtilisateurInexistantException {
		instance.encherir(o2, new Utilisateur("a","a","a"), 100, LocalDateTime.of(2017,3,15,12,25));
	}
	...
	@Test
	public void testEncherir3() throws ObjetInexistantException, UtilisateurInexistantException {
		assertNull(instance.encherir(o2, u2, 150, LocalDateTime.of(2017,3,15,12,20)));	
	}
	
	@Test
	public void testEncherir4() throws ObjetInexistantException, UtilisateurInexistantException {
		assertNull(instance.encherir(o2, u2, 150, LocalDateTime.of(2017,3,15,12,20)));	
	...
	@Test
	public void testEncherir5a() throws ObjetInexistantException, UtilisateurInexistantException {
		assertNull(instance.encherir(o1, u3, 200, LocalDateTime.of(2017,3,15,12,20)));
		
	}
	
	@Test
	public void testEncherir5b() throws ObjetInexistantException, UtilisateurInexistantException {
		assertNull(instance.encherir(o1, u3, 200, LocalDateTime.of(2017,3,15,12,15)));
	}
	
	@Test
	public void testEncherir5c() throws ObjetInexistantException, UtilisateurInexistantException {
		assertNull(instance.encherir(o1, u3, 150, LocalDateTime.of(2017,3,15,12,25)));
	}
	
	@Test
	public void testEncherir5d() throws ObjetInexistantException, UtilisateurInexistantException {
	...
	@Test(expected = ObjetInexistantException.class)
	public void testEncherir8() throws ObjetInexistantException, EnchereInexistanteException, UtilisateurInexistantException {
	...
	@Test
	public void testAccepter3() throws ObjetInexistantException, EnchereInexistanteException, UtilisateurInexistantException {
		instance.accepter(o1);
	...
	@Test
	public void testAccepter5() throws ObjetInexistantException, EnchereInexistanteException {
		instance.accepter(o1);
