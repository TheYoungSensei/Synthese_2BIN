...
public class TestEnchere {
	public static void main(String[] args)
		...
		Objet ob1 = instance.mettreEnVente("biblioth�que", user1);
		Enchere ench1 = instance.encherir(ob1, user2, 50, LocalDateTime.of(2015, 2, 7, 13, 48));
		
		System.out.println(ench1.getObjet().ajouterEnchere(
		    new Enchere(ench1.getObjet(), LocalDateTime.of(2015, 2, 8, 13, 48), 150, user3))+" (TRUE attendu)");
		...
		System.out.println(instance.fournirObjetschetes(user2).size() + " devrait etre 2");
