...
public class TestDomaine {
	...
	public static void main(String[] args) {
		...
		System.out.println("3."+usr.objetsAchetes().equals(usr.clone().objetsAchetes()) + " (TRUE attendu)");
		System.out.println("4."+((usr.objetsAchetes()) == usr.clone().objetsAchetes()) + " (FALSE attendu)");
		...
		System.out.println("12."+ench.getEncherisseur().equals(ench.getEncherisseur()) + " (TRUE attendu)");
		System.out.println("13."+(ench.getEncherisseur() == ench.getEncherisseur()) + " (FALSE attendu)");
