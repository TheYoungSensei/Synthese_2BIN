						...
						<tbody>
							...
							<tr>
								<td class="uml"><ul class="list-unstyled">
										...
										<c:forEach var="getter" items="${getters}">
											<li
												<c:if test="${getter.deClasse}"> class="static"
											</c:if>
												<c:if test="${getter.abstrait}"> class="abstract"
											</c:if>>${getter.visibilite.valeur}
												${getter.nom}</li>
										</c:forEach>
										
										<c:forEach var="setter" items="${setters}">
											<li
												<c:if test="${setter.deClasse}"> class="static"
											</c:if>
												<c:if test="${setter.abstrait}"> class="abstract"
											</c:if>>${setter.visibilite.valeur}
												${setter.nom}</li>
										</c:forEach>
