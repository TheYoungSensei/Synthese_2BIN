...
public class Trajet implements Comparable<Trajet>, Cloneable, Serializable {
  ...
  public String toString() {
    return "De " + gareDepart + " à " + gareArrivee + " : " + distance + " km";
  }
  ...
  @Override
  public int compareTo(Trajet obj) {
    Trajet trajet = (Trajet) obj;
    if (trajet.gareDepart != this.getGareDepart())
      return this.gareDepart.compareTo(trajet.gareDepart);
    return this.gareArrivee.compareTo(trajet.gareArrivee);
