 ...
 * formbox instance from the newsletter modal. It also supports the addition of
 * a "referrer" field, with the value able to be changed via a URL query
 * parameter for simple tracking.
 * @param {Element} el The form element.
 * @constructor
 */
dac.NewsletterFbForm = function(el) {
  /**
   * The newsletter container element.
   * @private {Element}
   */
  this.el_ = el;

  /**
   * The newsletter form element.
   * @private {Element}
   */
  this.form_ = this.el_.querySelector('form');

  /**
   * The newsletter form's submit element.
   * @private {Element}
   */
 ...
 * @private
 */
dac.NewsletterFbForm.CLOSE_DELAY_ = 300;

/**
 * Switches view to display form after close.
 * @private
 */
dac.NewsletterFbForm.prototype.closeHandler_ = function() {
  setTimeout(function() {
    $(this.el_).trigger('swap-reset');
  }.bind(this), dac.NewsletterFbForm.CLOSE_DELAY_);
};
 ...
 * @private
 */
dac.NewsletterFbForm.prototype.reset_ = function() {
 ...
 * @private
 */
dac.NewsletterFbForm.prototype.successHandler_ = function() {
 ...
 * @private
 */
dac.NewsletterFbForm.prototype.submitClickHandler_ = function() {
 ...
 * @private
 */
dac.NewsletterFbForm.prototype.submitHandler_ = function(e) {
  e.preventDefault();
...
$(document).on('ready.aranja', function() {
  ...
  for (var i = 0; i < elements.length; i++) {
    new dac.NewsletterFbForm(elements[i]);
  }
});
