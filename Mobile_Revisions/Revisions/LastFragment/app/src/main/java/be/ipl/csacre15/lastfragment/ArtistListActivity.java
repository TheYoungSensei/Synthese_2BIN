...
public class ArtistListActivity extends AppCompatActivity implements LastModel.LastObserver{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mArtistView = (View) findViewById(R.id.artist_list);
    ...
    protected void onResume() {
        super.onResume();
        ArtistContent.clearAll();
        model.regiterObserver(this);
        ConnectivityManager connMgr = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
        if(networkInfo != null && networkInfo.isConnected()) {
            //fetch data
            Util.showProgress(true, mArtistView, mProgressView, getApplicationContext());
    ...
    public void notifyChange() {
        Util.showProgress(false, mArtistView, mProgressView, getApplicationContext());
