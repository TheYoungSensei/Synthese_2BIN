...
import be.ipl.csacre15.jemanager.businessDays.BusinessDayListActivity;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                HTTPUtils.performPostCall(HTTPUtils.URL, map);
                return true;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(LoginActivity.this, BusinessDayListActivity.class);
